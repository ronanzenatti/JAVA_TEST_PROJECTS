...
public class ListaProdutos extends javax.swing.JFrame {
    ...
    public ListaProdutos() {
        ...
        jTableProdutos.setRowSorter(new TableRowSorter<TableModel>(modelo));
    ...
    public void readForFind() {
        ...
        for (Produtos p : pDAO.readForFind(campo[cboFind.getSelectedIndex()], busca)) {
            modelo.addRow(new Object[]{
                p.getIdproduto(),
                p.getDescricao(),
                p.getMarca(),
    ...
    private void initComponents() {
        ...
        jTableProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição", "Marca", "Categoria", "Estoque", "Valor Unitário"
            }
        ) {
        ...
        if (jTableProdutos.getColumnModel().getColumnCount() > 0) {
            ...
            jTableProdutos.getColumnModel().getColumn(5).setMinWidth(130);
            jTableProdutos.getColumnModel().getColumn(5).setPreferredWidth(130);
            jTableProdutos.getColumnModel().getColumn(5).setMaxWidth(130);
        }
        ...
        cboFind.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código", "Descrição", "Marca", "Categoria", "Estoque", "Valor Unitário" }));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (jTableProdutos.getSelectedRow() != -1 && jTableProdutos.getSelectedRowCount() == 1) {
            AlterarProduto au = new AlterarProduto((int) jTableProdutos.getValueAt(jTableProdutos.getSelectedRow(), 0));
            au.setVisible(true);
            dispose();
        } else {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (jTableProdutos.getSelectedRow() != -1 && jTableProdutos.getSelectedRowCount() == 1) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                if (pDAO.delete((int) jTableProdutos.getValueAt(jTableProdutos.getSelectedRow(), 0))) {
                    readJTable();
                }
            }
        } else {
