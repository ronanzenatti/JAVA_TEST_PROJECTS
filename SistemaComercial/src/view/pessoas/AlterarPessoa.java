...
public class AlterarPessoa extends javax.swing.JFrame {
     ...
     * @param idpessoa
     */
    public AlterarPessoa(int idpessoa) {
        initComponents();
        p = new PessoasDAO().findById(idpessoa);
        ...
        txtDocFed.setText(p.getDoc_fed());
        txtDocEst.setText(p.getDoc_est());
        ...
        txtInscMun.setText(String.valueOf(p.getInsc_mun()));
        txtEmail.setText(p.getEmail());
        txtTelFixo.setText(p.getTel_fixo());
        txtTelCom.setText(p.getTel_com());
        txtTelCel.setText(p.getTel_cel());
    }
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                        .addComponent(cboTipo, 0, 193, Short.MAX_VALUE)
                                        .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarPessoa(0).setVisible(true);
            }
        });
    }
