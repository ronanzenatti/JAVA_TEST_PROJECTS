...
public class ListaClientes extends javax.swing.JFrame {
    ...
    public void readJTable() {
        ...
        for (Clientes c : cJPA.findClientesEntities()) {
            modelo.addRow(new Object[]{
                c.getIdcliente(),
                c.getNome(),
                (c.getTipoPessoa() == 'F' ? "Física" : "Jurídica"),
                c.getDocFed(),
                c.getCidade(),
                c.getTelefones(),
                c.getEmail()
    ...
    public void readForFind() {      
     /*   String busca = txtFind.getText();
        ...
        for (Clientes c : cJPA.findForFind(campo[cboFind.getSelectedIndex()], busca)) {
             modelo.addRow(new Object[]{
                c.getIdcliente(),
                c.getNome(),
                (c.getTipoPessoa() == 'F' ? "Física" : "Jurídica"),
    ...
    private void initComponents() {
        ...
        jTableEstabelecimentos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Tipo", "CPF/CNPJ", "Cidade", "Telefones", "E-mail"
            }
        ) {
        ...
        jTableEstabelecimentos.setColumnSelectionAllowed(true);
        ...
        if (jTableEstabelecimentos.getColumnModel().getColumnCount() > 0) {
            ...
            jTableEstabelecimentos.getColumnModel().getColumn(2).setMinWidth(100);
            jTableEstabelecimentos.getColumnModel().getColumn(2).setPreferredWidth(100);
            jTableEstabelecimentos.getColumnModel().getColumn(2).setMaxWidth(100);
            jTableEstabelecimentos.getColumnModel().getColumn(3).setMinWidth(130);
            jTableEstabelecimentos.getColumnModel().getColumn(3).setPreferredWidth(130);
            jTableEstabelecimentos.getColumnModel().getColumn(3).setMaxWidth(130);
        }
