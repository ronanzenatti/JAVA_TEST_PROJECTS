...
public class AlterarEstabelecimento extends javax.swing.JFrame {
     ...
     * @param id
     */
    public AlterarEstabelecimento(int id) {
        initComponents();
        objFactory = Persistence.createEntityManagerFactory("RT_ParkingPU");
        manager = objFactory.createEntityManager();

        e = new EstabelecimentosJpaController(objFactory).findEstabelecimentos(id);

        txtNome.setText(e.getNome());
        txtCNPJ.setText(e.getCnpj());
        txtVC.setText(String.valueOf(e.getVagasCarro()));
        txtVM.setText(String.valueOf(e.getVagasMoto()));
        ...
        txtTelefones.setText(e.getTelefones());
        txtEmail.setText(e.getEmail());
        txtDataInicio.setDate(e.getDtInicio());
        txtDataTermino.setDate(e.getDtFim());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alteração de Estabelecimento");
        ...
        txtDataInicio.setPreferredSize(new java.awt.Dimension(87, 23));

        txtDataTermino.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtDataTermino.setPreferredSize(new java.awt.Dimension(87, 23));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            if (eJPA.edit(e)) {
                JOptionPane.showMessageDialog(null, "Alterado com Sucesso!!!", "RT Parking", JOptionPane.INFORMATION_MESSAGE);
                ListaEstabelecimentos lp = new ListaEstabelecimentos();
                lp.setVisible(true);
                dispose();
            }
        } catch (NonexistentEntityException ex) {
            Logger.getLogger(AlterarEstabelecimento.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(AlterarEstabelecimento.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarEstabelecimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarEstabelecimento(0).setVisible(true);
            }
        });
    }
