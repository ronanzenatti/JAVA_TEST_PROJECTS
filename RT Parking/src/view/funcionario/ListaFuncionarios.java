...
public class ListaFuncionarios extends javax.swing.JFrame {
    ...
    public ListaFuncionarios() {
        ...
        jTableFuncionarios.setRowSorter(new TableRowSorter<TableModel>(modelo));
        
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer(); 
        centralizado.setHorizontalAlignment(SwingConstants.CENTER);        
        jTableFuncionarios.getColumnModel().getColumn(0).setCellRenderer(centralizado);
    ...
    public void readJTable() {
        ...
        for (Funcionarios f : fJPA.findFuncionariosEntities()) {
    ...
    public void readForFind() {
        ...
        for (Funcionarios f : fJPA.findForFind(campo[cboFind.getSelectedIndex()], busca)) {
            modelo.addRow(new Object[]{
                f.getIdfuncionario(),
                f.getNome(),
                f.getCpf(),
    ...
    private void initComponents() {
        ...
        jTableFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Doc. Federal", "Cidade", "E-mail", "Telefones"
            }
        ) {
        ...
        if (jTableFuncionarios.getColumnModel().getColumnCount() > 0) {
            ...
            jTableFuncionarios.getColumnModel().getColumn(2).setMinWidth(130);
            jTableFuncionarios.getColumnModel().getColumn(2).setPreferredWidth(130);
            jTableFuncionarios.getColumnModel().getColumn(2).setMaxWidth(130);
        }
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        CadastroFuncionario cp = new CadastroFuncionario();
        cp.setVisible(true);
        dispose();
    }//GEN-LAST:event_btnCreateActionPerformed

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (jTableFuncionarios.getSelectedRow() != -1 && jTableFuncionarios.getSelectedRowCount() == 1) {
            AlterarFuncionario tela = new AlterarFuncionario((int) jTableFuncionarios.getValueAt(jTableFuncionarios.getSelectedRow(), 0));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (jTableFuncionarios.getSelectedRow() != -1 && jTableFuncionarios.getSelectedRowCount() == 1) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                try {
                    if (fJPA.destroy((int) jTableFuncionarios.getValueAt(jTableFuncionarios.getSelectedRow(), 0))) {
                        readJTable();
                    }
